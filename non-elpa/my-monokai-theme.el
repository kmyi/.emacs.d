;;; my-monokai-theme.el --- A fruity color theme for Emacs.

;; Adapted to my style from the original
...
(deftheme my-monokai "The Monokai colour theme")
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       (s-mode-line-inactive-bg  (if my-monokai-high-contrast-mode-line
                                     gray-l my-monokai-bg))
       (s-mode-line-inactive-bc  (if my-monokai-high-contrast-mode-line
                                     my-monokai-fg my-monokai-hl))

       ;; powerline
       (s-powerline-active1-bg   (if my-monokai-high-contrast-mode-line
                                     gray-l gray))
       (s-powerline-active2-bg   (if my-monokai-high-contrast-mode-line
                                     gray gray-l))
       (s-powerline-inactive1-bg (if my-monokai-high-contrast-mode-line
                                     gray gray-d))
       (s-powerline-inactive2-bg (if my-monokai-high-contrast-mode-line
                                     my-monokai-bg gray))
       ...
       (terminal-s-mode-line-bg           (if my-monokai-high-contrast-mode-line
                                              terminal-my-monokai-fg terminal-my-monokai-hl))
  ...
  (custom-theme-set-faces
   ...
   ;; powerline
   `(powerline-active1
     ((,class (:background ,s-powerline-active1-bg :foreground ,my-monokai-fg))
      (,terminal-class (:background ,terminal-gray :foreground ,my-monokai-fg))))

   `(powerline-active2
     ((,class (:background ,s-powerline-active2-bg :foreground ,my-monokai-fg))
      (,terminal-class (:background ,terminal-gray-l :foreground ,my-monokai-fg))))
  ...
  (custom-theme-set-variables
   ...
   ;; pos-tip
   `(pos-tip-foreground-color ,my-monokai-bg)
